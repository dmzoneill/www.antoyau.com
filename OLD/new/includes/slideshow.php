...
if ($handle = opendir('/home/sites/site3/web/media/')) {
$imgs = array();
...
print "</table><br>";	
print "<a href=\"#\" onclick=\"slideshow('includes/slideshow.php?imageid=$total');\"><img  alt='Show next 9' src='images/arrowl.gif' border=0></a>";
	
	
	}
	else {
	$last = $imageid -9;
	echo "<a href=\"#\" onclick=\"slideshow('includes/slideshow.php?imageid=$last');\"><img src='images/arrowr.gif' alt='Show previous 9' border=0></a><br><br>"; 
	$total = $imageid;
	$matrix = 3;
...
$next = $total;
if($next<count($imgs)){
	echo "<a href=\"#\" onclick=\"slideshow('includes/slideshow.php?imageid=$next');\"><img src='images/arrowl.gif' alt='Show next 9' border=0></a><br>"; 
	}
