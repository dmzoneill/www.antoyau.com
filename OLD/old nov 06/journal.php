...
print "<br><table bgcolor=#ffffff width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\">";
print "<tr>";
print "<td width=100% valign=top align=left class=maintext>";
print "<table bgcolor=#223344 width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"3\">";
print "<tr>";
...
print "<br><table bgcolor=#ffffff width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
print "<tr>";
print "<td width=100% valign=top align=left class=maintext>";
print "<table bgcolor=#223344 width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"2\">";
print "<tr>";
print "<td width=100% valign=top align=left class=maintext>";
print "<a name='$id'>&nbsp;</a> : ";
