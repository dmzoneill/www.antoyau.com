...
?>
  ...
  <table width=600s bgcolor="#FEFEFE" cellpadding="0" cellspacing="0" border="0"><tr><td>
...
$ttt = "eeeeee";
	...
	if($p==0){
			...
			print "<td width='20%' valign=middle><center><a href=index.php?pagename=tour&gigid=$id><b><font color=blue>$other</b></font></a></center></td>";
...
for($i=0;$i<count($sql);$i++){
	...
	if($p==0){
			...
			print "<table width=\"100%\" bgcolor=\"$bgcolor\" cellspacing=\"2\" cellpadding=\"3\">";
			print "<tr>";
